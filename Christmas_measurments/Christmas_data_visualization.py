...
plt.savefig(file_path + "plots/RE_vs_time.png")  # Save the figure to a file
...
plt.savefig(file_path + "plots/<E>_vs_time.png")  # Save the figure to a file
...
umidità = data_temp["Umidità_relativa(%)"]
