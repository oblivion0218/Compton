...
data = pd.read_csv(file_path + "results/Misure_gennaio_5.txt", delim_whitespace=True)
...
plt.savefig(file_path + "plots/RE_vs_time_gennaio_5.png")  # Save the figure to a file
...
plt.savefig(file_path + "plots/<E>_vs_time_gennaio_5.png")  # Save the figure to a file
