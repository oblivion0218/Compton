...
data = pd.read_csv(file_path + "results/Misure_gennaio_4.txt", delim_whitespace=True)
...
plt.savefig(file_path + "plots/RE_vs_time_gennaio_4.png")  # Save the figure to a file
...
plt.savefig(file_path + "plots/<E>_vs_time_gennaio_4.png")  # Save the figure to a file
