...
file_path = "/mnt/c/Users/User/Desktop/info/Compton/Measurments/Measurments_trasmission/60_deg/"
# file_path = "/mnt/c/Users/ASUS/Desktop/WSL_shared/Compton/Measurments/Measurments_riflection/60_deg/"
...
def fit_peaks(hist, peak, sigma, left_step, right_step, x_axis_name, y_axis_name, file_path):
    ...
    mpr.stampa_graph_fit(hist, f_background, file_path + "background_.png", "Background",
                         x_axis_name, y_axis_name, "", 200, 1200)

    #-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-
    # FIT - Complete model
    #-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-
    f_true = ROOT.TF1("model", "pol4(0) + gaus(5)", 0, 2000) 
